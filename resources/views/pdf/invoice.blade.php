    ...
    <main>
        ...
        <table class="table table-borderless">
            ...
            <tbody>
                ...
                <!-- Neu: Gutschein 20%-->
                @if ($user->voucher != '' && $user->voucher == 'HOCHZEITCLICK152024')
                    @php
        ...
        <div>
            ...
            Wir ersuchen um Überweisung des Gesamtbetrags bis zum 15. Jänner 2024 auf unser Konto: <br>
            <b>BIC EASYATW1</b><br>
